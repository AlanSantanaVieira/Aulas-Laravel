...
<head>
    ...
    <!-- Referenciando o arquivo css do Public -->
    <link href="{{ asset("css/bootstrap.min.css") }}" rel="stylesheet"
        integrity="sha384-4Q6Gf2aSP4eDXB8Miphtr37CMZZQ5oXLH2yaXMJ2w8e2ZtHTl7GptT4jmndRuHDT">

    <link rel="apple-touch-icon" href="{{asset("icons/apple-touch.png") }}" sizes="180x180">
    ...
    <!-- Custimização do estilo template -->
...
<body> <svg xmlns="http://www.w3.org/2000/svg" class="d-none">
    ...
    <header class="navbar sticky-top bg-dark flex-md-nowrap p-0 shadow" data-bs-theme="dark"> <a
            class="navbar-brand col-md-3 col-lg-2 me-0 px-3 fs-6 text-white" href="#">Sanjess</a>
    ...
    <!-- Biblioteca Jquery para testar alert -->
    <script src="https://cdnjs.cloudflare.com/ajax/libs/jquery/3.6.0/jquery.min.js" integrity="sha512-894YE6QWD5I59HgZOGReFYm4dnWc1Qt5NtvYSaNcOP+u1T9qYdvdihz0PPSiiqn/+/3e7Jo4EaG7TubfWGUrMQ==" crossorigin="anonymous" referrerpolicy="no-referrer"></script>

    <!-- Biblioteca Jquery para testar mascara de telefone -->
